...
//carregar documento - FIM
            ...
            function verCampos() {
                var msn = null;
                if ($('#km').val() === "") {
                    msn = "Informe a Kilometragem Atual do Veículo.\n";
                }
                if ($('#item').val() === "") {
                    msn = msn + "Informe o Item de Manutenção.\n";
                }
                if ($('#periodo').val() === "0") {
                    msn = msn + "Informe o Período de Mautenção.\n";
                }
                if ($('#ano').val() === "") {
                    msn = msn + "Informe o ano de fabricação do veículo.";
                }
                return msn;
            }
            ...
            function insereLinha(param) {
                ...
                if (verif === null) {
                    ...
                    if (medida === "Km") {
                        ...
                        if (um > 0 && um >= ano && um <= d) {
                            ver = true;
                            data = um + parseInt(periodo);
                        }
                        else if (um === 0) {
                            ver = true;
                            data = ano + parseInt(periodo);
                        } else {
                            alert("Ano de manutenção não pode ser menor que ano de fabricação do veículo ou maior que o ano atual!");
                            ver = false;
                        }
                    }
                        ...
                        <div class="col-lg-12"> 
                            <div class="panel panel-success">
                                ...
                                <div class="panel-body" >
                                    <input value="${veiculo.dataCadastro}" name="veiculo.dataCadastro" title="Data de Cadastro do Veículo." hidden/>
