                            ...
                            <div class="panel-body" >
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input class="form-control input-sm" id="marca" value="${veiculo.getMarca()}" name="veiculo.marca"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control input-sm" id="modelo" value="${veiculo.getModelo()}" name="veiculo.modelo"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control input-sm" id="placa" value="${veiculo.getPlaca()}" name="veiculo.placa"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control input-sm" id="ano" value="${veiculo.getAno()}" name="veiculo.ano"/>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control input-sm" id="kmAtual" name="veiculo.kmAtual" placeholder="" title="Informe a Kilometragem atual do veículo."/>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input class="form-control input-sm" id="kmDia" name="veiculo.kmDia" placeholder="" title="Kilometragem média diária rodada pelo veículo."/>
